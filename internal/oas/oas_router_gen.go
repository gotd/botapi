						...
						case 'A': // Prefix: "All"
							...
							case 'G': // Prefix: "GeneralForumTopicMessages"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "POST":
										r.name = "UnpinAllGeneralForumTopicMessages"
										r.summary = ""
