...
// setDefaults set default value of fields.
func (s *GetStarTransactions) setDefaults() {
	{
		val := int(0)
		s.Offset.SetTo(val)
	}
...
// setDefaults set default value of fields.
func (s *MenuButtonDefault) setDefaults() {
	{
		val := string("default")
		s.Type = val
	}
...
// setDefaults set default value of fields.
func (s *MenuButtonWebApp) setDefaults() {
	{
		val := string("web_app")
		s.Type = val
	}
...
// setDefaults set default value of fields.
func (s *ResultArrayOfMessageId) setDefaults() {
	{
		val := bool(true)
		s.Ok = val
	}
