	...
	tests := []struct {
	...
	}{
		{
			...
			want: oas.ChatPermissions{
				...
				CanSendAudios:         oas.NewOptBool(false),
				CanSendVideos:         oas.NewOptBool(false),
				CanSendDocuments:      oas.NewOptBool(false),
				CanSendPhotos:         oas.NewOptBool(false),
				CanManageTopics:       oas.NewOptBool(false),
		...
		},
		{
			...
			want: oas.ChatPermissions{
				...
				CanSendAudios:         oas.NewOptBool(true),
				CanSendVideos:         oas.NewOptBool(true),
				CanSendDocuments:      oas.NewOptBool(true),
				CanSendPhotos:         oas.NewOptBool(true),
				CanManageTopics:       oas.NewOptBool(true),
